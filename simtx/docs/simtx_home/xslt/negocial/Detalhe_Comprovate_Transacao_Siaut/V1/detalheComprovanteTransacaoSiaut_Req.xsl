	...
	<xsl:template match="/BUSDATA">
		<multicanal:SERVICO_ENTRADA 
			...
			<detalhe:CONSULTA_TRANSACOES_CONTA_ENTRADA>
				...
				<PERIODO>
					<INICIO><xsl:value-of select="*[2]/DETALHE_COMPROVANTE_TRANSACAO/DATA_EFETIVACAO"/></INICIO>
					<FIM><xsl:value-of select="*[2]/DETALHE_COMPROVANTE_TRANSACAO/DATA_EFETIVACAO"/></FIM>
				</PERIODO>
				<NSU><xsl:value-of select="*[2]/DETALHE_COMPROVANTE_TRANSACAO/NSU"/></NSU>
				<ACAO>CONSULTAR</ACAO>
				<SOLICITACOES>
