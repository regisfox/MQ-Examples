...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/BUSDATA">
		<ns:DETALHE_AGENDAMENTO_TRANSACAO_ENTRADA 
			xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
			xmlns:h="http://caixa.gov.br/sicco/comuns/header"
			xmlns:ns="http://caixa.gov.br/sicco/detalhe_agendamento_transacao/v1/ns">
			<HEADER>
				<SERVICO>
			...
			<NSU_SIMTX><xsl:value-of select="*[2]/DETALHE_AGENDAMENTO_TRANSACAO/NSU"/></NSU_SIMTX>
		</ns:DETALHE_AGENDAMENTO_TRANSACAO_ENTRADA>
	</xsl:template>
</xsl:stylesheet>