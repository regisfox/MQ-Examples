...
<xsl:stylesheet version="2.0" 
	...
	xmlns:sibar_base="http://caixa.gov.br/sibar" xmlns:valida_cartao="http://caixa.gov.br/sibar/valida_cartao"
	xmlns:valida_senha="http://caixa.gov.br/sibar/valida_senha"
...
<!-- <xsl:import href="../../../../comuns/header/V1/templateHeader_Req.xsl"/> -->
	...
	<xsl:template match="/BUSDATA">
		<multicanal:SERVICO_ENTRADA
			...
			<xsl:if test="*[2]/*[local-name()='DETALHE_AGENDAMENTO_TRANSACAO']/SISTEMA_ORIGEM/text() = 'SIAUT'">
