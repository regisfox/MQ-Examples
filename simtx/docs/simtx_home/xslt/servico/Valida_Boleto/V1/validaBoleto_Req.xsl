	...
	<xsl:template match="/BUSDATA">
		<multicanal:SERVICO_ENTRADA 
			...
			<valida:VALIDA_REGRAS_BOLETO_ENTRADA>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/CODIGO_BARRAS">
						<CODIGO_BARRAS><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/CODIGO_BARRAS" /></CODIGO_BARRAS>
					</xsl:when>
					<xsl:otherwise>
						<CODIGO_BARRAS><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_ENTRADA']/CONSULTA_BOLETO/CODIGO_BARRAS" /></CODIGO_BARRAS>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/FLAG_ULTIMA_PARCELA_VIAVEL">
						<ULTIMA_PARCELA_VIAVEL><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/FLAG_ULTIMA_PARCELA_VIAVEL" /></ULTIMA_PARCELA_VIAVEL>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/FLAG_PAGAMENTO_PARCIAL">
						<PAGAMENTO_PARCIAL><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/FLAG_PAGAMENTO_PARCIAL" /></PAGAMENTO_PARCIAL>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/QUANTIDADE_PAGAMENTO_PARCIAL_PERMITIDO">
						<QUANTIDADE_PAGAMENTO_PARCIAL_PERMITIDO><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/QUANTIDADE_PAGAMENTO_PARCIAL_PERMITIDO" /></QUANTIDADE_PAGAMENTO_PARCIAL_PERMITIDO>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/NUMERO_PARCELA_ATUAL">
						<NUMERO_PARCELA_ATUAL><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/NUMERO_PARCELA_ATUAL" /></NUMERO_PARCELA_ATUAL>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/RECEBE_VALOR_DIVERGENTE">
						<RECEBE_VALOR_DIVERGENTE><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/RECEBE_VALOR_DIVERGENTE" /></RECEBE_VALOR_DIVERGENTE>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/ESPECIE">
						<ESPECIE><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/ESPECIE" /></ESPECIE>
					</xsl:when>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TIPO_BOLETO">
						<ESPECIE><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TIPO_BOLETO" /></ESPECIE>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/CALCULOS/CALCULO_CAIXA/DATA_VENCIMENTO_UTIL">
						<DATA_VENCIMENTO_UTIL><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/CALCULOS/CALCULO_CAIXA/DATA_VENCIMENTO_UTIL" /></DATA_VENCIMENTO_UTIL>
					</xsl:when>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/DATA_VENCIMENTO">
						<DATA_VENCIMENTO_UTIL><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/DATA_VENCIMENTO" /></DATA_VENCIMENTO_UTIL>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/MINIMO/VALOR">
						<VALOR_MINIMO_CONSULTA><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/MINIMO/VALOR" /></VALOR_MINIMO_CONSULTA>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/MAXIMO/VALOR">
						<VALOR_MAXIMO_CONSULTA><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/TITULO/MAXIMO/VALOR" /></VALOR_MAXIMO_CONSULTA>
					</xsl:when>
					<xsl:otherwise>
				...
				<xsl:choose>
					<xsl:when test="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/CALCULOS/CALCULO_CAIXA/VALOR_TOTAL">
						<VALOR_TOTAL_CALCULADO><xsl:value-of select="$transacao_origem/*[local-name()='CONSULTA_BOLETO_SAIDA']/CONSULTA_BOLETO/CALCULOS/CALCULO_CAIXA/VALOR_TOTAL" /></VALOR_TOTAL_CALCULADO>
					</xsl:when>
					<xsl:otherwise>
