package br.gov.caixa.simtx.persistencia.cache.agendamento.test;
	...
	private List<Mtxtb034TransacaoAgendamento> listaAgendamentos(Mtxtb034TransacaoAgendamento consulta) {
		...
		if (consulta.getNuUnidade() == 625) {
			for (int i = 0; i < 2; i++) {
				...
				mtxtb034TransacaoAgendamento.setNuNsuTransacaoAgendamento(1000 + i);
				...
				agendamentosCancelados.add(mtxtb034TransacaoAgendamento);
			}
		}
